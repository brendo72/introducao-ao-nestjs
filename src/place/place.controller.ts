import { BadRequestException, Body, Controller, Delete, Put, Post, Get, UploadedFiles, UseInterceptors, Param } from '@nestjs/common';
    ...
    schema: {
      ...
      properties: {
        ...
        images: {
          ...
          description: 'As novas imagens substituem as anteriores (Máximo 3 imagens)'
        }
      }
    }
  })
